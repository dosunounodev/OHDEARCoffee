<aside id="blog-aside" class="blog-aside">
    <div class="aside-content">
      ...
      <div class="aside-frame frame-site">
        ...
        <p>Te espero en mi website <a href="http://ohdearcoffee.com" target="_blank">ohdearcoffee.com</a> donde podrás ver mis cursos, guías y mucho más</p>
      </div>

      <div class="aside-frame frame-cats">
        <ul>
          <li><img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-fruit.svg" alt="">
          <a href="http://ohdearcoffee.com/wordpress/category/cultivo-y-procesos/">
          Cultivos y Procesos</a></li>
          <li><a href="http://ohdearcoffee.com/wordpress/category/tueste/">
          Tueste</a>
          ...
          <a href="http://ohdearcoffee.com/wordpress/category/barista/">
          Barista</a></li>
          <li><a href="http://ohdearcoffee.com/wordpress/category/recetas/">
          Recetas</a>
          ...
          <a href="http://ohdearcoffee.com/wordpress/category/cafeterias/">
          Cafeterías</a></li>
        </ul>
      </div>
